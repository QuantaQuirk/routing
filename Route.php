...
use QuantaQuirk\Routing\Contracts\CallableDispatcher;
...
use QuantaQuirk\Routing\Matching\HostValidator;
use QuantaQuirk\Routing\Matching\MethodValidator;
use QuantaQuirk\Routing\Matching\SchemeValidator;
use QuantaQuirk\Routing\Matching\UriValidator;
...
class Route
{
    ...
    public function getMissing()
    {
        ...
        return is_string($missing) &&
            Str::startsWith($missing, [
                'O:47:"QuantaQuirk\\SerializableClosure\\SerializableClosure',
                'O:55:"QuantaQuirk\\SerializableClosure\\UnsignedSerializableClosure',
     ...
     *
     * @return \QuantaQuirk\Routing\Contracts\ControllerDispatcher
     */
