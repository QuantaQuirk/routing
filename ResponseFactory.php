...
use QuantaQuirk\Contracts\Routing\ResponseFactory as FactoryContract;
use QuantaQuirk\Contracts\View\Factory as ViewFactory;
use QuantaQuirk\Http\JsonResponse;
use QuantaQuirk\Http\Response;
use QuantaQuirk\Routing\Exceptions\StreamedResponseException;
...
class ResponseFactory implements FactoryContract
{
     ...
     *
     * @var \QuantaQuirk\Contracts\View\Factory
     */
    protected $view;
     ...
     *
     * @param  \QuantaQuirk\Contracts\View\Factory  $view
     ...
     * @param  array  $headers
     * @param  int  $options
     * @return \QuantaQuirk\Http\JsonResponse
     */
