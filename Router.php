...
use QuantaQuirk\Contracts\Routing\Registrar as RegistrarContract;
...
use QuantaQuirk\Routing\Events\RouteMatched;
...
/**
 * @mixin \QuantaQuirk\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \QuantaQuirk\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \QuantaQuirk\Routing\Route|null
     */
    protected $current;
     ...
     * @param  \QuantaQuirk\Container\Container|null  $container
     * @return void
     */
    ...
    {
        return $this->any($uri, '\QuantaQuirk\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\QuantaQuirk\Routing\ViewController')
                ->setDefaults([
                    'view' => $view,
                    'data' => $data,
     ...
     *
     * @param  \QuantaQuirk\Support\Collection  $middlewares
     * @return array
     */
     ...
     *
     * @return \QuantaQuirk\Routing\Route|null
     */
     ...
     *
     * @return \QuantaQuirk\Routing\RouteCollectionInterface
     */
