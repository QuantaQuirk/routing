...
namespace QuantaQuirk\Routing\Console;

use QuantaQuirk\Console\Concerns\CreatesMatchingTest;
...
class ControllerMakeCommand extends GeneratorCommand
{
    ...
    {
        return file_exists($customPath = $this->quantaquirk->basePath(trim($stub, '/')))
                        ? $customPath
                        : __DIR__.$stub;
    }
    ...
    protected function buildFormRequestReplacements(array $replace, $modelClass)
    {
        [$namespace, $storeRequestClass, $updateRequestClass] = [
            'QuantaQuirk\\Http', 'Request', 'Request',
        ];
