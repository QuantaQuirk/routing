...
use BackedEnum;
use Closure;
use QuantaQuirk\Contracts\Routing\UrlGenerator as UrlGeneratorContract;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \QuantaQuirk\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \QuantaQuirk\Routing\RouteCollectionInterface  $routes
     ...
     * @return string
     *
     * @throws \QuantaQuirk\Routing\Exceptions\UrlGenerationException
     */
     ...
     * @param  string  $root
     * @param  string  $path
     * @param  \QuantaQuirk\Routing\Route|null  $route
     * @return string
     */
     ...
     *
     * @return \QuantaQuirk\Routing\RouteUrlGenerator
     */
     ...
     *
     * @return \QuantaQuirk\Session\Store|null
     */
